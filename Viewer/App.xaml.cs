...
namespace Viewer
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (e.PrelaunchActivated == false)
            {
                if (rootFrame.Content == null)
                {
                    ...
                    // parameter
                    rootFrame.Navigate(typeof(Playback), e.Arguments);
                }
            ...
            ////SharingMgr.SetServerConnectionInfo("192.168.251.131", 20602);
        ...
        //public void NetworkUpdate(object sender, EventArgs e)
        //{
        //    SharingMgr.Update();
        //}
